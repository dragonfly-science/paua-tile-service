...
} from "./chunk-PYWR34RB.js";
import "./chunk-QMCL53JA.js";
import {
  TileState_default,
  getKeyZXY,
  toSize
...
var CANNOT_CONVERT_A_BIGINT_VALUE_TO_A_NUMBER = "Cannot convert a BigInt value to a number";
  ...
  constructor(input, _byteOffset, _length) {
    ...
    if (isFloat16Array(input)) {
      ...
      if (isNativeTypedArray(input)) {
        ...
        const BufferConstructor = !isSharedArrayBuffer(buffer2) ? SpeciesConstructor(buffer2, NativeArrayBuffer) : NativeArrayBuffer;
        if (IsDetachedBuffer(buffer2)) {
          throw NativeTypeError(ATTEMPTING_TO_ACCESS_DETACHED_ARRAYBUFFER);
        }
...
addDecoder([void 0, 1], () => import("./raw-V3XSM2ST.js").then((m) => m.default));
addDecoder(5, () => import("./lzw-T5A2CI2W.js").then((m) => m.default));
addDecoder(6, () => {
  throw new Error("old style JPEG compression is not supported.");
});
addDecoder(7, () => import("./jpeg-Q3OVSUC7.js").then((m) => m.default));
addDecoder([8, 32946], () => import("./deflate-HCUOKAR4.js").then((m) => m.default));
addDecoder(32773, () => import("./packbits-NNJLN7WG.js").then((m) => m.default));
addDecoder(34887, () => import("./lerc-F5GCNXZ2.js").then((m) => m.default));
addDecoder(50001, () => import("./webimage-OOG4Y5NK.js").then((m) => m.default));
  ...
  constructor(size = defaultPoolSize, createWorker) {
    ...
    if (size) {
      this._awaitingDecoder = createWorker ? Promise.resolve(createWorker) : new Promise((resolve) => {
        import("./decoder-5IQR2PKM.js").then((module) => {
...
var GeoTIFFSource = function(_super) {
  __extends2(GeoTIFFSource2, _super);
  function GeoTIFFSource2(options) {
    ...
    Promise.all(requests).then(function(sources) {
      ...
      console.error(error);
      self.error_ = error;
      self.setState(State_default.ERROR);
    });
    return _this;
  }
  ...
  GeoTIFFSource2.prototype.configure_ = function(sources) {
    ...
    var _loop_1 = function(sourceIndex2) {
      ...
      metadata[sourceIndex2] = new Array(imageCount);
      for (var imageIndex2 = 0; imageIndex2 < imageCount; ++imageIndex2) {
        ...
        metadata[sourceIndex2][imageIndex2] = image2.getGDALMetadata(0);
      ...
      if (!origin) {
        ...
        var message = "Origin mismatch for source ".concat(sourceIndex2, ", got [").concat(sourceOrigin, "] but expected [").concat(origin, "]");
      ...
      if (!resolutions) {
        ...
        var message = "Resolution mismatch for source ".concat(sourceIndex2, ", got [").concat(scaledSourceResolutions, "] but expected [").concat(resolutions, "]");
      ...
      if (!tileSizes) {
        ...
        assertEqual(tileSizes.slice(minZoom, tileSizes.length), sourceTileSizes, 0, "Tile size mismatch for source ".concat(sourceIndex2), this_1.viewRejector);
      }
    ...
    outer:
      for (var sourceIndex = 0; sourceIndex < sourceCount; ++sourceIndex) {
        ...
        var values2 = nodataValues[sourceIndex];
        var bands = this.sourceInfo_[sourceIndex].bands;
        if (bands) {
          for (var i = 0; i < bands.length; ++i) {
            if (!isNaN(values2[bands[i] - 1])) {
              this.addAlpha_ = true;
              break outer;
            }
          }
        ...
        for (var imageIndex = 0; imageIndex < values2.length; ++imageIndex) {
          if (!isNaN(values2[imageIndex])) {
            this.addAlpha_ = true;
            break outer;
          }
        }
  ...
  GeoTIFFSource2.prototype.loadTile_ = function(z, x, y) {
    ...
    var _loop_2 = function(sourceIndex2) {
      var source = sourceInfo[sourceIndex2];
    ...
    return Promise.all(requests).then(function(sourceSamples) {
      ...
      for (var pixelIndex = 0; pixelIndex < pixelCount; ++pixelIndex) {
        ...
        for (var sourceIndex2 = 0; sourceIndex2 < sourceCount; ++sourceIndex2) {
          ...
          if (normalize) {
            var stats = metadata[sourceIndex2][0];
            if (min === void 0) {
