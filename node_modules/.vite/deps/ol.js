import {
  ...
  Overlay_default
} from "./chunk-VQDPC2SQ.js";
import {
  Layer_default as Layer_default2
} from "./chunk-AJQMJ6WA.js";
import {
  CLASS_COLLAPSED,
  CLASS_CONTROL,
  CLASS_HIDDEN,
...
var Icon = function(_super) {
  ...
  function Icon2(opt_options) {
    ...
    _this.iconImage_ = get2(image, src, _this.imgSize_ !== void 0 ? _this.imgSize_ : null, _this.crossOrigin_, imageState, _this.color_);
...
var ControlledMap = function(_super) {
  __extends41(ControlledMap2, _super);
...
var OverviewMap = function(_super) {
  __extends41(OverviewMap2, _super);
...
var ZoomSlider = function(_super) {
  __extends43(ZoomSlider2, _super);
...
var ZoomToExtent = function(_super) {
  __extends44(ZoomToExtent2, _super);
...
var Interaction = function(_super) {
  __extends45(Interaction2, _super);
...
var DoubleClickZoom = function(_super) {
  __extends46(DoubleClickZoom2, _super);
...
var PointerInteraction = function(_super) {
  __extends47(PointerInteraction2, _super);
...
var DragRotate = function(_super) {
  __extends49(DragRotate2, _super);
...
var DragBoxEvent = function(_super) {
  __extends51(DragBoxEvent2, _super);
...
var KeyboardPan = function(_super) {
  __extends53(KeyboardPan2, _super);
...
var KeyboardZoom = function(_super) {
  __extends54(KeyboardZoom2, _super);
...
var MouseWheelZoom = function(_super) {
  __extends55(MouseWheelZoom2, _super);
...
var PinchRotate = function(_super) {
  __extends56(PinchRotate2, _super);
...
var DragAndDropEvent = function(_super) {
  __extends58(DragAndDropEvent2, _super);
...
var DragAndDrop = function(_super) {
  __extends58(DragAndDrop2, _super);
...
var DragRotateAndZoom = function(_super) {
  __extends59(DragRotateAndZoom2, _super);
...
var MultiLineString = function(_super) {
  __extends61(MultiLineString2, _super);
...
var MultiPoint = function(_super) {
  __extends62(MultiPoint2, _super);
...
var MultiPolygon = function(_super) {
  __extends63(MultiPolygon2, _super);
...
var ExtentEvent = function(_super) {
  __extends65(ExtentEvent2, _super);
...
var ModifyEvent = function(_super) {
  __extends66(ModifyEvent2, _super);
...
var SelectEvent = function(_super) {
  __extends67(SelectEvent2, _super);
  ...
  Snap2.prototype.snapTo = function(pixel, pixelCoordinate, map) {
    ...
    var getResult = function() {
      if (closestVertex) {
        ...
        var squaredPixelDistance = squaredDistance2(pixel, vertexPixel);
      ...
      for (var i = 0; i < segmentsLength; ++i) {
        ...
        if (segmentData.feature.getGeometry().getType() !== GeometryType_default.CIRCLE) {
          segmentData.segment.forEach(function(vertex2) {
            ...
            var delta2 = squaredDistance2(projectedCoordinate, tempVertexCoord);
    ...
    if (this.edge_) {
      for (var i = 0; i < segmentsLength; ++i) {
        ...
        if (vertex) {
          var delta = squaredDistance2(projectedCoordinate, vertex);
...
var TranslateEvent = function(_super) {
  __extends69(TranslateEvent2, _super);
